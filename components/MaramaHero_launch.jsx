...
const COPY = {
  ...
  ES: {
    ...
    p_intro:"Marama trabaja con una tarifa mensual fija. Elija el nivel que se adapta a su propiedad y a su tranquilidad. Sin cargos ocultos ni suplementos por gestiones habituales.",
    p_tiers:[
      {name:"Essential",price:"€150",period:"/mes",annual:"€1.800 / año",tag:null,
       items:["Visita mensual con informe fotográfico","Custodia de llaves y acceso de emergencia","Línea WhatsApp en su idioma","Domicilio español para correspondencia oficial","Seguimiento de plazos fiscales y coordinación con gestor","Registro mensual en vídeo — protección anti-okupa"]},
      {name:"Comfort",price:"€200",period:"/mes",annual:"€2.400 / año",tag:"Más popular",
       items:["Todo lo de Essential","Intervención ante Calima y Gota Fría — antes y después","Reinicio de domótica — cámaras, router, termostatos","Coordinación y supervisión de trabajos","Control de suministros y cuotas de comunidad","Inspección trimestral en profundidad"]},
      {name:"Prestige",price:"€275",period:"/mes",annual:"€3.300 / año",tag:null,
       items:["Todo lo de Comfort","Preparación antes de su llegada — ventilada, revisada, abastecida","Cierre completo a su salida","Compra de bienvenida a petición","Respuesta prioritaria por WhatsApp","Informe anual completo del estado del inmueble"]},
    ],
