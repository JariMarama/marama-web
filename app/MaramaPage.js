...
const COPY = {
  ...
  ES: {
    ...
    faqs:[
      ...
      {q:"¿Trabajáis con anfitriones de alquiler vacacional?",a:"Sí. Si gestionas un alquiler vacacional en Dénia — ya sea a través de Airbnb, Booking.com o de forma directa — ofrecemos un servicio dedicado de check-in y check-out, inspecciones entre estancias y respuesta ante tormentas. Todo facturado por visita, sin cuota mensual. Escríbenos y te explicamos cómo funciona."},
